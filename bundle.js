...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configureStore = __webpack_require__(242);
	...
	var history = (0, _reactRouterRedux.syncHistoryWithStore)(_reactRouter.hashHistory, _configureStore2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _github = __webpack_require__(245);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchBar = __webpack_require__(250);

	var _SearchBar2 = _interopRequireDefault(_SearchBar);

	var _GithubUser = __webpack_require__(251);

	var _GithubUser2 = _interopRequireDefault(_GithubUser);

	var _githubActions = __webpack_require__(252);

	var githubActions = _interopRequireWildcard(_githubActions);
	  ...
	  _createClass(Github, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_SearchBar2.default, this.props),
	        _react2.default.createElement(
	          'h1',
	          null,
	          'GitHub User'
	        ),
	        _react2.default.createElement(_GithubUser2.default, { github: this.props.github })
	      );
	    }
	  }]);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    actions: (0, _redux.bindActionCreators)(githubActions, dispatch)
	  };
	};

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Github);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GithubUser = function (_Component) {
	  _inherits(GithubUser, _Component);

	  function GithubUser() {
	    _classCallCheck(this, GithubUser);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(GithubUser).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function fetchUser(options) {
	  ...
	  return function (dispatch) {
	    fetch(GITHUB_API + '/users/' + username).then(processResponse).then(function (res) {
	      return dispatch({
	        type: 'FETCH_USER',
	        user: res
	      });
	...
	function processResponse(response) {
	  ...
	  return response.text().then(function (body) {
	    ...
	    throw { body: body, statusCode: response.status };
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var About = exports.About = function About() {
	  return _react2.default.createElement(
	    'div',
	    null,
	    'This is a simple project that displays GitHub user information by using an asynchonous Redux flow'
	  );
	};
